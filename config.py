...
class Config(object):
    ...
    TG_BOT_TOKEN = os.environ.get("57256c4196b08ffaea61271aca07d7d1")
    # The Telegram API things
    APP_ID = int(os.environ.get("28993901"))
    API_HASH = os.environ.get("57256c4196b08ffaea61271aca07d7d1")
    # Get these values from my.telegram.org
    # Array to store users who are authorized to use the bot
    AUTH_USERS = set(int(x) for x in os.environ.get("1273492006", "").split())
